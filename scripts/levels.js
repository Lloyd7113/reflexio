...
function Level_mousemove(evt)
{
	for(var i = 0;i < mirrorCount;i++)
	{
		if(mirrorDrag[i])
		{
			mirrors[i].x = mousex - (mirrors[i].width/2);
			mirrors[i].y = mousey - (mirrors[i].height/2);
			break;
		}
	}
	...
	for(var i = 0;i < CircMirrorCount ;i++)
	{
		if(CircMirrorDrag[i])
		{
			CircMirrors[i].x = mousex - (mirrors[i].width/2);
			CircMirrors[i].y = mousey - (mirrors[i].height/2);
			break;
		}
	}
}
